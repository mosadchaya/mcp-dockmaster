...
export const HomeIcon = ({ className }: { className?: string }) => {
  return (
    <svg className={cn(className)} viewBox="0 0 24 24" width="24" height="24" fill="none">
      <path
...
export const ServersIcon = ({ className }: { className?: string }) => {
  return (
    <svg className={cn(className)} viewBox="0 0 24 24" width="24" height="24" fill="none">
      <path
...
export const RegistryIcon = ({ className }: { className?: string }) => {
  return (
    <svg className={cn(className)} viewBox="0 0 24 24" width="24" height="24" fill="none">
      <path
