...
#[tauri::command]
pub async fn list_tools(state: State<'_, AppContext>) -> Result<Vec<Value>, String> {
    mcp_core::mcp_proxy::list_tools(state.inner()).await
}

/// List all available tools from all running MCP servers
#[tauri::command]
pub async fn list_all_server_tools(state: State<'_, AppContext>) -> Result<Vec<Value>, String> {
...
#[tauri::command]
pub async fn get_all_server_data(state: State<'_, AppContext>) -> Result<Value, String> {
    mcp_core::mcp_proxy::get_all_server_data(state.inner()).await
}

/// Save the MCP state to the database
#[tauri::command]
pub async fn save_mcp_state_command(state: State<'_, AppContext>) -> Result<String, String> {
...
#[tauri::command]
pub async fn load_mcp_state_command(state: State<'_, AppContext>) -> Result<String, String> {
